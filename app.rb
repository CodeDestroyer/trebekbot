...
post "/" do
  begin
    ...
    elsif params[:text].match(/^new q/i)
...
def respond_with_help
  reply = <<help
Type `#{ENV["BOT_USERNAME"]} new q` to start a new round of Slack Jeopardy. I will pick the category and price. Anyone in the channel can respond.
